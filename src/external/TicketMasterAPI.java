...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "0OOxgoA4CdGdKYOYd1rktDnAPH5LbZ7I";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			keyword = URLEncoder.encode(keyword, "UTF-8"); // handle spaces
	...
	// convert JSONArray to a List of Item
