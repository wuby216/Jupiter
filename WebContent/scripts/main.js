...
//						timeout: 10000
	...
	function ajax(method, url, data, successCallback, errorCallback) {
		...
		xhr.open(method, url, true); // third para true: asynchronized request, do not block when waiting response

		xhr.onload = function() {  // check if response is sent back, cannot guarantee successfully responded
			if (xhr.status === 200) {
		...
		xhr.onerror = function() {     // error when sending request
